...
const RewardsPage = loadable(() => import(/* webpackChunkName: "ProfilePage" */ '../containers/RewardsPage/RewardsPage'));
...
const routeConfiguration = (layoutConfig) => {
  ...
  return [
    ...
    {
      path: '/landing/:subCategory',
      name: 'LandingPageListing',
      component: LandingPage,
      loadData: pageDataLoadingAPI.LandingPage.loadData,
    },
    {
...

    {
      ...
      // loadData: pageDataLoadingAPI.RewardsPage.loadData,
    },
    {

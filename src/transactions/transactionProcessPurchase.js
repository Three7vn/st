...
export const transitions = {
  ...
  RETURN_SHIPPING_LABEL_BY_CUSTOMER: "transition/return-shipping-label-by-customer",
...
export const states = {
  ...
  RETURN_LABEL_CREATED: "return-shipping-created",
...
export const graph = {
  ...
  states: {
    ...
    [states.OFFER]: {
      on: {
        [transitions.OFFER_ACCEPT_BY_PROVIDER]: states.PURCHASED,
    ...
    [states.RETURN_ORDER]: {
      on: {
        [transitions.RETURN_SHIPPING_LABEL_BY_CUSTOMER]: states.RETURN_LABEL_CREATED,
      },
    },

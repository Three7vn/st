  ...
  if (image == null || variants.length === 0) {
    ...
    return (
      <div className={noImageClasses}>
       {listingImageUrl ? <img src={listingImageUrl} alt="..." /> :<div className={css.noImageWrapper}>
    ...
    <div>
      {isListingCard && (
        <span
          ...
          onClick={e => {
            e.preventDefault(), handleFavouriteItems();
          }}
        >
          {index > -1 ? <IconCollection icon="disLikeIcon" /> : <IconCollection icon="likeIcon" />}
        </span>
      )}

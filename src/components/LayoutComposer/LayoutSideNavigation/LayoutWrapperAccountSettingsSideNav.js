...
const LayoutWrapperAccountSettingsSideNavComponent = props => {
  ...
  const { currentPage , isUserAdmin} = props;
  ...
  const tabs = [
    ...
    {
      text: <FormattedMessage id="LayoutWrapperAccountSettingsSideNav.profileSettingsPageTabTitle" />,
    ...
    // (isUserAdmin ? {
    //   text: <FormattedMessage id="LayoutWrapperAccountSettingsSideNav.discountTabTitle" />,
    //   selected: currentPage === 'DiscountPage',
    //   id: 'DiscountPageTab',
    //   linkProps: {
    //     name: 'DiscountPage',
    //   },
    // } : {}),
    {
      text: <FormattedMessage id="LayoutWrapperAccountSettingsSideNav.ManageSubscriptionPageTabTitle" />,

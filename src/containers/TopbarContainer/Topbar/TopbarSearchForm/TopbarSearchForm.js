...
const KeywordSearchField = props => {
  const { keywordSearchWrapperClasses, iconClass, intl, isMobile, inputRef ,isSearchPage} = props;
  return (
    <div className={keywordSearchWrapperClasses}>
      <button className={css.searchSubmit}>
        <div className={iconClass}>
          <IconSearchDesktop isSearchPage={isSearchPage}/>
        </div>
      </button>
      <Field
        name="keywords"
          ...
          return (
            <input
              ...
              placeholder={intl.formatMessage({
                id: isSearchPage ? 'TopbarSearchForm.searchPlaceholder'  :'TopbarSearchForm.placeholder',
              })}
              autoComplete="off"
            />
          );

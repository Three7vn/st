...
const getInitialValues = (props, existingListingTypeInfo, listingTypes, listingFieldsConfig) => {
  ...
  return {
    ...
    description,
    category,
    subCategory:subCategoryWithChild,
    condition,
    capacity,
    storage,
    model,
...
const EditListingDetailsPanel = props => {
  ...
  const {fullName,userName} = currentUser?.attributes?.profile?.publicData ||{};
        ...
        <EditListingDetailsForm
          ...
          onSubmit={values => {
            ...
            const updateValues = {
              ...
              description,
              publicData: {
                businessListingUnavailable:false,
                listingType,
                transactionProcessAlias,
                unitType,
                isDeleted : false,
                ...
                subCategoryWithChild:subCategory,
                ...
                size,
                color,
                trendingListing:false,
                beforeItsGone:false,
                sellerName:userName||fullName,

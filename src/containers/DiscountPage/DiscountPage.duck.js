...
export const CLEAR_UPDATED_FORM = 'app/DiscountPage/CLEAR_UPDATED_FORM';

export const UPLOAD_IMAGE_REQUEST = 'app/DiscountPage/UPLOAD_IMAGE_REQUEST';
export const UPLOAD_IMAGE_SUCCESS = 'app/DiscountPage/UPLOAD_IMAGE_SUCCESS';
export const UPLOAD_IMAGE_ERROR = 'app/DiscountPage/UPLOAD_IMAGE_ERROR';

export const UPDATE_PROFILE_REQUEST = 'app/DiscountPage/UPDATE_PROFILE_REQUEST';
export const UPDATE_PROFILE_SUCCESS = 'app/DiscountPage/UPDATE_PROFILE_SUCCESS';
export const UPDATE_PROFILE_ERROR = 'app/DiscountPage/UPDATE_PROFILE_ERROR';
...
export const updateProfile = (actionPayload, code) => {
  return (dispatch, getState, sdk) => {
    dispatch(updateProfileRequest(code || true));

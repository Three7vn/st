...
export const MEMBER_MONTHLY = 'Member-Monthly';
export const MEMBER_YEARLY = 'Member-Yearly';
export const BUSINESS_MONTHLY = 'Business Enterprise-Monthly';
export const BUSINESS_YEARLY = 'Business Enterprise-Yearly';
export const SUBSCRIPTION_STATUS_ACTIVE = 'active';
export const SUBSCRIPTION_STATUS_CANCEL = 'canceled';
export const SUBSCRIPTION_STATUS_TRIAL = 'trialing';
export const SUBSCRIPTION_BUSINESSENTERPRISE = 'business-enterprise';
export const SUBSCRIPTION_BUSINESSMEMBER = 'business-member';
export const SUBSCRIPTION_MEMBER_PLAN = 'member-plan';

export const USER_TYPE_INDIVIDUAL = 'individual-user';
export const USER_TYPE_BUSINESS = 'business-user';

export const USER_PLAN_TYPE = 'business-member';

export const PHONES_ACCESSORIES = 'phones-accessories';
export const CLOTHING = 'clothing';

export const PAYOUT_WITH_CRYPTO = 'withCrypto';
export const PAYOUT_WITH_STRIPE = 'withStripe';

export const FREE_PLAN_PRICE_LIMIT = 500;
export const MEMBER_PLAN_PRICE_LIMIT = 25000;

export const FREE_PLAN_COUNT_LIMIT = 50;
export const MEMBER_PLAN_COUNT_LIMIT = 1000;
